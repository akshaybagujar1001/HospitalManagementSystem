        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyRules = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssetMaintenances_Users_PerformedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicationStockMovements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicationStockMovements_Medications_MedicationId",
                        column: x => x.MedicationId,
                        principalTable: "Medications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicationStockMovements_Users_PerformedByUserId",
                        column: x => x.PerformedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    NurseNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LicenseNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyContactName = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffShifts_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuspectedDiagnosis = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    AIResponse = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIDiagnoses_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AIDiagnoses_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedNurseId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmergencyCases_Nurses_AssignedNurseId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmergencyCases_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NurseTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NurseTasks_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NurseTasks_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NurseTasks_Users_AssignedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RadiologyOrders_Doctors_RadiologistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Results = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    AmountCovered = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsuranceClaims_InsuranceCompanies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "InsuranceCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemReferenceId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RevenueRecords_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_RevenueRecords_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_RevenueRecords_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RadiologyImages_RadiologyOrders_RadiologyOrderId",
                        column: x => x.RadiologyOrderId,
                        principalTable: "RadiologyOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RadiologyImages_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Findings = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Impression = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RadiologyReports_Doctors_RadiologistId",
                        column: x => x.RadiologistId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RadiologyReports_RadiologyOrders_RadiologyOrderId",
                        column: x => x.RadiologyOrderId,
                        principalTable: "RadiologyOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DispensedByUserId = table.Column<int>(type: "int", nullable: false),
                    DispensedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionFulfillments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescriptionFulfillments_Medications_MedicationId",
                        column: x => x.MedicationId,
                        principalTable: "Medications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrescriptionFulfillments_Users_DispensedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIDiagnoses_DoctorId",
                table: "AIDiagnoses",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_AIDiagnoses_PatientId",
                table: "AIDiagnoses",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetMaintenances_PerformedByUserId",
                table: "AssetMaintenances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyCases_AssignedNurseId",
                table: "EmergencyCases",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceClaims_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicationStockMovements_MedicationId",
                table: "MedicationStockMovements",
                column: "MedicationId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicationStockMovements_PerformedByUserId",
                table: "MedicationStockMovements",
                column: "PerformedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NurseTasks_AssignedByUserId",
                table: "NurseTasks",
                column: "AssignedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_NurseTasks_NurseId",
                table: "NurseTasks",
                column: "NurseId");

            migrationBuilder.CreateIndex(
                name: "IX_NurseTasks_PatientId",
                table: "NurseTasks",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionFulfillments_DispensedByUserId",
                table: "PrescriptionFulfillments",
                column: "DispensedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionFulfillments_MedicationId",
                table: "PrescriptionFulfillments",
                column: "MedicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RadiologyImages_RadiologyOrderId",
                table: "RadiologyImages",
                column: "RadiologyOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_RadiologyImages_UploadedByUserId",
                table: "RadiologyImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RadiologyReports_RadiologyOrderId",
                table: "RadiologyReports",
                column: "RadiologyOrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RevenueRecords_CreatedByUserId",
                table: "RevenueRecords",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RevenueRecords_InvoiceId",
                table: "RevenueRecords",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_RevenueRecords_PatientId",
                table: "RevenueRecords",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffShifts_CreatedByUserId",
                table: "StaffShifts",
                column: "CreatedByUserId");
